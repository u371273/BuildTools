...
@REM below added by kun on 2019-08-15
...
@rem @if "%VS100COMNTOOLS%"=="" goto error_no_VS100COMNTOOLSDIR

@rem @call "%VS100COMNTOOLS%VCVarsQueryRegistry.bat" 32bit No64bit
